  ...
  <div class="wrap wqmain_body">
    ...
    <div class="wqform_body">
      <form name="update_form" id="update_form">
        ...
        <div>&nbsp;</div>
        <div class="wqlabel">Mobile</div>
      <div class="wqfield">
        <input type="text" class="wqtextfield" name="wqmobile" id="wqmobile" placeholder="Enter Your Moble" value="<?=$data->mobile?>" />
      </div>
      <div id="wqmobile_message" class="wqmessage"></div>
        <div>&nbsp;</div>
...
<div class="wrap wqmain_body">
  ...
  <div class="wqform_body">
    <form name="entry_form" id="entry_form">
      ...
      <div class="wqlabel">Mobile</div>
      <div class="wqfield">
        <input type="text" class="wqtextfield" name="wqmobile" id="wqmobile" placeholder="Enter Your Moble" value="" />
      </div>
      <div id="wqmobile_message" class="wqmessage"></div>
